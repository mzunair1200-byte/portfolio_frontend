    ...
    <section className="min-h-screen flex flex-col justify-center bg-[#DEDBD2] text-[#1A1A1A] px-6 lg:px-20 relative overflow-hidden min-w-0">
      ...
      <div className="absolute top-10 left-6 lg:left-20 flex justify-between items-center w-[calc(100%-3rem)] lg:w-[calc(100%-10rem)] border-b border-black/10 pb-4 z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="uppercase text-[10px] font-black tracking-widest">Rawalpindi, PK</span>
        </div>

        <div className="hidden md:flex">
          <span className="bg-[#1A1A1A] text-[#DEDBD2] px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.2em]">
      ...
      <div className="grid grid-cols-[repeat(12,minmax(0,1fr))] items-center relative z-10 pt-20 min-w-0">
        ...
        <div className="col-span-12 lg:col-span-5 relative mt-16 lg:mt-0 px-2 lg:px-4 min-w-0">
          ...
          <div className="absolute top-10 -left-6 bg-[#2D4F3E] text-white p-6 rounded-2xl max-w-[180px] shadow-xl rotate-[-5deg] hidden lg:block text-xs font-medium">
            &quot;I don&apos;t just write code—I build intelligent systems that scale.&quot;
          </div>
        </div>
      </div>
    </section>
